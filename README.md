...
普通进展仍然可以放在“事实记录”里，但不要为了填满模板，把所有对话都写进“有价值的事情”。记录应该留下具体、真实、以后能用上的内容。
...
| 记录一轮工作 | `记录一下今天做的内容` | 将当前对话中的事实和价值信息写入对应阶段 |
...
6. 为当前阶段生成 3 至 5 个简短选题。
7. 更新整个项目总结和选题汇总中受影响的部分。
8. 检查是否误造日期、结果、指标或用户观点。
...
- **有价值的事情**：按知识卡点、高频问题、AI 协作纠正与返工分类；
...
普通日志通常按时间记录发生了什么。Record 在阶段事实之外，还专门整理知识卡点、高频问题、AI 协作纠正、返工原因和内容选题，因此更适合项目复盘和经验复用。
